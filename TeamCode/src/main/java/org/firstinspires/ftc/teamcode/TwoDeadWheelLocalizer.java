...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2118.89525916; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1549.1931124; // x position of the perpendicular encoder (in tick units)
    }
